                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('admin.products')}}" class="btn btn-success float-end">
                                            All products
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Enter short description"name="short_description" wire:model="short_description"></textarea>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea class="form-control" placeholder="Description"name="description" wire:model="description"></textarea>
                                         @error('description')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="regular_price" class="form-control" placeholder="Regular price" wire:model="regular_price">
                                        @error('regular_price')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="sale_price" class="form-control" placeholder="sale price" wire:model="sale_price">
                                        @error('sale_price')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
